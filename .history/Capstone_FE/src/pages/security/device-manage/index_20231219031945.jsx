...
const DeviceManage = () => {
  ...
  const [handleOpenCreateDevice, setHandleOpenCreateDevice] = useState(false)
  const [handleCloseCreateDevice, setHandleCloseCreateDevice] = useState(false)
  ...
  const handleSaveChangeStatus = async () => {
    try {
      ...
      if (error.response.status === 406) {
        toast.error("Contained 2 devices in 1 room!")
      }
    }
  }
  ...
  return (
    <>
      ...
      <CreateDevice handleOpenCreateDevice={handleOpenCreateDevice} handleCloseCreateDevice={handleCloseCreateDevice} />
      {/* modal Change Status */}
      <Modal
        open={isShowStatus}
